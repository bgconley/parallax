...
- Do not begin any later phase without explicit user instruction. Phase 0 through Phase 8 are complete. Do not start Phase 9 or broaden later optional-extension work without explicit user instruction. Close and verify the current phase acceptance gate before advancing.
