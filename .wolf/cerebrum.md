...
- Do not begin any later phase without explicit user instruction. Phase 5 is complete; Phase 6 is not active unless the user explicitly starts it. Close and verify the current phase acceptance gate before advancing.
